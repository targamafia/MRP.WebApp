...
export const QuestionForm = (props: { questionHook: Function }) => {
  ...
  if (!props.questionHook) props.questionHook = useCreateAssessmentQuestion;

  const { mutate, error, isLoading, reset } = props.questionHook({
